    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('afiliado.index')); ?>" >
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('afiliado.index')); ?>" class="nav-link">Medicos</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('especialidades.index')); ?>" class="nav-link">Especialidades</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('principal.index')); ?>" class="nav-link">Tickets</a>
                            </li>
