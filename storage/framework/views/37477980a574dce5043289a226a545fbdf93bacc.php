        ...
        <div class="col-xl-3 col-md-6">
            ...
            <div class="card card-animate bg-info">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-bold ff-secondary mb-4 text-white"><span
            ...
            <div class="card crm-widget">
                <div class="card-body p-0">
                    <div class="row row-cols-md-3 row-cols-1">
                        ...
                        <div class="col col-lg border-end">
                            <div class="mt-3 mt-md-0 py-4 px-3">
                                <h5 class="text-muted text-uppercase fs-14">Lead Coversation <i
                        ...
                        <div class="col col-lg border-end">
                            <div class="mt-3 mt-lg-0 py-4 px-3">
                                <h5 class="text-muted text-uppercase fs-14">Daily Average Income <i
                                        class="ri-arrow-up-circle-line text-success fs-18 float-end align-middle"></i>
                                </h5>
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                        ...
                        <div class="col col-lg">
                            <div class="mt-3 mt-lg-0 py-4 px-3">
                                <h5 class="text-muted text-uppercase fs-14">Annual Deals <i
                                        class="ri-arrow-down-circle-line text-danger fs-18 float-end align-middle"></i>
                                </h5>
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
            ...
            <div class="card">
                <div class="card-body p-0">
                    ...
                    <div class="d-flex p-3">
                        ...
                        <div>
                            <p class="fs-16 lh-base">Personalized <span class="fw-bold">Gift
                        ...
                        <li class="list-group-item ps-0">
                            <div class="row align-items-center g-3">
                                ...
                                <div class="col">
                                    ...
                                    <a href="#" class="text-reset fs-15 mb-0">Meeting for campaign with
                                        sales team</a>
                                </div>
                        ...
                        <li class="list-group-item ps-0">
                            <div class="row align-items-center g-3">
                                ...
                                <div class="col">
                                    ...
                                    <a href="#" class="text-reset fs-15 mb-0">Adding a new event with
                                        attachments</a>
                                </div>
                                <div class="col-sm-auto">
                                    <div class="avatar-group">
                        ...
                        <li class="list-group-item ps-0">
                            <div class="row align-items-center g-3">
                                ...
                                <div class="col">
                                    ...
                                    <a href="#" class="text-reset fs-15 mb-0">Create new project
                                        Bundling Product</a>
                                </div>
                                <div class="col-sm-auto">
                                    <div class="avatar-group">
                        ...
                        <li class="list-group-item ps-0">
                            <div class="row align-items-center g-3">
                                ...
                                <div class="col">
                                    ...
                                    <a href="#" class="text-reset fs-15 mb-0">Weekly closed sales won
                            ...
                            <div data-simplebar style="max-height: 364px;" class="p-3">
                                <div class="acitivity-timeline acitivity-main">
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h6 class="mb-1">Added new <span class="fw-bold">style
                                                    collection</span></h6>
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="text-muted mb-0">Flash sale by <a
                                                    ...
                                                    class="link-secondary fw-semibold">Zoetic
                                                    Fashion</a></p>
                        ...
                        <li class="list-group-item px-0">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <p class="fs-14 mb-0 text-muted"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\velzon_Laravel\creative\resources\views/widgets.blade.php ENDPATH**/ ?>