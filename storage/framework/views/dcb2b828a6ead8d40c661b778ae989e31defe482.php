                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarnft">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="apps-nft-auction" class="nav-link" data-key="t-live-auction"> <?php echo app('translator')->get('translation.auction'); ?> </a>
                                        </li>
                                        <li class="nav-item">
...
<?php /**PATH C:\xampp\htdocs\velzon_Laravel\creative\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>