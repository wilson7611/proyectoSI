                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="index" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="http://127.0.0.1:8000/assets/images/logo-sm.png" alt=""
                                        height="22">
                                </span>
                                <span class="logo-lg">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Especialidades</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item active">Cerrar Sesion</li>
                                    </ol>
                                </div>
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    <h4 class="fs-22 fw-bold ff-secondary text-white mb-4">
                                                        Total fichas: <span class="counter-value" data-target="559.25">8</span>k
                                                    </h4>
                                                    <a href="" class="text-decoration-underline text-white-50">Ingresar</a>
                                                </div>
                        ...
                        <div class="d-flex gap-2 flex-wrap img-switch">
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                    <img src="http://127.0.0.1:8000/assets/images/sidebar/img-1.jpg"
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                    <img src="http://127.0.0.1:8000/assets/images/sidebar/img-2.jpg"
                                        class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                    <img src="http://127.0.0.1:8000/assets/images/sidebar/img-3.jpg"
                                        class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                    <img src="http://127.0.0.1:8000/assets/images/sidebar/img-4.jpg"
                                        class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\vistasLaravel\resources\views/plantilla/index.blade.php ENDPATH**/ ?>