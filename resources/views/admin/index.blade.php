...
<head>
    <meta charset="utf-8" />
    <title> Dashboards | Velzon - Admin & Dashboard Template</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Premium Multipurpose Admin & Dashboard Template" name="description" />
    <meta content="Themesbrand" name="author" />
    <!-- App favicon -->
    <link rel="shortcut icon" href="http://127.0.0.1:8000/assets/images/favicon.ico">
    <link href="http://127.0.0.1:8000/assets/libs/jsvectormap/jsvectormap.min.css" rel="stylesheet" type="text/css" />
<link href="http://127.0.0.1:8000/assets/libs/swiper/swiper.min.css" rel="stylesheet" type="text/css" />
<!-- Layout config Js -->
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <form id="logout-form" action="http://127.0.0.1:8000/logout" method="POST" style="display: none;">
                            <input type="hidden" name="_token" value="OVGWI38g10TBhZwuEH0aX22RRGyRnSBNCJ8jyY1L">                        </form>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{route('afiliado.index')}}" >
                        <i class="ri-dashboard-2-line"></i> <span>Registro</span>
                    </a>
                </li> <!-- end Dashboard Menu -->
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{route('afiliado.index')}}" class="nav-link">Medicos</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('especialidades.index')}}" class="nav-link">Especialidades</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('principal.index')}}" class="nav-link">Tickets</a>
                            </li>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="fs-14 my-1"><a
                                                                href="http://127.0.0.1:8000/apps-ecommerce-product-details"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div
                                                        class="avatar-sm bg-light rounded p-1 me-2">
                                                        <img src="http://127.0.0.1:8000/assets/images/products/img-4.png"
                                                            alt="" class="img-fluid d-block" />
                                                    </div>
                                                    <div>
                                                        <h5 class="fs-14 my-1"><a
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="http://127.0.0.1:8000/assets/images/companies/img-1.png"
                                                            alt="" class="avatar-sm p-2" />
                                                    </div>
                                                    <div>
                                                        <h5 class="fs-14 my-1 fw-medium"><a
                                                                href="http://127.0.0.1:8000/apps-ecommerce-seller-details"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="http://127.0.0.1:8000/assets/images/companies/img-2.png"
                                                            alt="" class="avatar-sm p-2" />
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h5 class="fs-14 my-1 fw-medium"><a
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="http://127.0.0.1:8000/assets/images/companies/img-3.png"
                                                            alt="" class="avatar-sm p-2" />
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="http://127.0.0.1:8000/assets/images/companies/img-8.png"
                                                            alt="" class="avatar-sm p-2" />
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h5 class="fs-14 my-1 fw-medium"><a
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="http://127.0.0.1:8000/assets/images/companies/img-5.png"
                                                            alt="" class="avatar-sm p-2" />
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h5 class="fs-14 my-1 fw-medium"><a
                            ...
                            <div class="table-responsive table-card">
                                <table
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <a href="http://127.0.0.1:8000/apps-ecommerce-order-details"
                ...
                <div class="card-body p-0">
                    ...
                    <div data-simplebar style="max-height: 410px;" class="p-3 pt-0">
                        <div class="acitivity-timeline acitivity-main">
                            ...
                            <div class="acitivity-item py-3 d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                                        <a href="http://127.0.0.1:8000/apps-ecommerce-product-details"
                                            class="bg-light rounded p-1">
                                            <img src="http://127.0.0.1:8000/assets/images/products/img-8.png" alt=""
                                                class="img-fluid d-block" />
                                        </a>
                                        <a href="http://127.0.0.1:8000/apps-ecommerce-product-details"
                                            class="bg-light rounded p-1">
                                            <img src="http://127.0.0.1:8000/assets/images/products/img-2.png" alt=""
                                                class="img-fluid d-block" />
                                        </a>
                                        <a href="http://127.0.0.1:8000/apps-ecommerce-product-details"
                                            class="bg-light rounded p-1">
                                            <img src="http://127.0.0.1:8000/assets/images/products/img-10.png" alt=""
                                                class="img-fluid d-block" />
                                        </a>
                                    </div>
                            ...
                            <div class="acitivity-item d-flex">
                                <div class="flex-shrink-0">
                                    <img src="http://127.0.0.1:8000/assets/images/users/avatar-3.jpg" alt=""
                                        class="avatar-xs rounded-circle acitivity-avatar" />
                                </div>
                                <div class="flex-grow-1 ms-3">
                    ...
                    <div class="card sidebar-alert bg-light border-0 text-center mx-4 mb-0 mt-3">
                        <div class="card-body">
                            <img src="http://127.0.0.1:8000/assets/images/giftbox.png" alt="">
                            <div class="mt-4">
...
<script src="http://127.0.0.1:8000/assets/libs/jsvectormap/jsvectormap.min.js"></script>
<script src="http://127.0.0.1:8000/assets/libs/swiper/swiper.min.js"></script>
<!-- dashboard init -->
<script src="http://127.0.0.1:8000/assets/js/pages/dashboard-ecommerce.init.js"></script>
