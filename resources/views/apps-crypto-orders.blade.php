            ...
            <div class="card-body border border-dashed border-end-0 border-start-0">
                <div class="row g-2">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <select class="form-control" data-choices data-choices-search-false data-choices-removeItem name="choices-single-default"
                    ...
                    <div class="col-xl-2 col-md-4">
                        <select class="form-control" data-choices data-choices-search-false data-choices-removeItem name="choices-single-default2"
