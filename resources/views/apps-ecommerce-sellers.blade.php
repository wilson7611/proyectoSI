    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card ribbon-box right overflow-hidden">
            <div class="card-body text-center p-4">
                ...
                <h5 class="mb-1 mt-4"><a href="{{URL::asset('/apps-ecommerce-seller-details')}}" class="link-primary">Force Medicines</a></h5>
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card">
            <div class="card-body text-center p-4">
                ...
                <h5 class="mb-1 mt-4"><a href="{{URL::asset('/apps-ecommerce-seller-details')}}" class="link-primary">Micro Design</a></h5>
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card">
            <div class="card-body text-center p-4">
                ...
                <h5 class="mb-1 mt-4"><a href="{{URL::asset('/apps-ecommerce-seller-details')}}" class="link-primary">Nesta Technologies</a></h5>
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card ribbon-box right overflow-hidden">
            <div class="card-body text-center p-4">
                ...
                <h5 class="mb-1 mt-4"><a href="{{URL::asset('/apps-ecommerce-seller-details')}}" class="link-primary">iTest Factory</a></h5>
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card">
            <div class="card-body text-center p-4">
                ...
                <h5 class="mb-1 mt-4"><a href="{{URL::asset('/apps-ecommerce-seller-details')}}" class="link-primary">Meta4Systems</a></h5>
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card ribbon-box right overflow-hidden">
            <div class="card-body text-center p-4">
                ...
                <h5 class="mb-1 mt-4"><a href="{{URL::asset('/apps-ecommerce-seller-details')}}" class="link-primary">Digitech Galaxy</a></h5>
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card ribbon-box right overflow-hidden">
            <div class="card-body text-center p-4">
                ...
                <h5 class="mb-1 mt-4"><a href="{{URL::asset('/apps-ecommerce-seller-details')}}" class="link-primary">Syntyce Solutions</a></h5>
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card">
            <div class="card-body text-center p-4">
                ...
                <h5 class="mb-1 mt-4"><a href="{{URL::asset('/apps-ecommerce-seller-details')}}" class="link-primary">Zoetic Fashion</a></h5>
