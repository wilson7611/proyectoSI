                                    ...
                                    <td>
                                        <div class="d-flex">
                                           ...
                                           <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-16"><a href="{{URL::asset('/apps-ecommerce-product-details')}}" class="link-primary">Sweatshirt for Men (Pink)</a></h5>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                           ...
                                           <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-16"><a href="{{URL::asset('/apps-ecommerce-product-details')}}" class="link-primary">Noise NoiseFit Endure Smart Watch</a></h5>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                           ...
                                           <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-16"><a href="{{URL::asset('/apps-ecommerce-product-details')}}" class="link-primary">350 ml Glass Grocery Container</a></h5>
